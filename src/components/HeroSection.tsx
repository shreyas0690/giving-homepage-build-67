...
const HeroSection = () => {
  return <section className="bg-gradient-to-br from-rose-50 via-pink-50 to-purple-50 py-12 lg:py-20">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
              <img src="https://images.pexels.com/photos/2324837/pexels-photo-2324837.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop" alt="Surgeons performing surgery in hospital" className="w-full h-[500px] object-cover" />
            ...
            <div className="absolute -top-4 -right-4 w-24 h-24 sm:w-32 sm:h-32 rounded-full overflow-hidden shadow-lg border-4 border-white">
              <img src="https://images.unsplash.com/photo-1582750433449-648ed127bb54?auto=format&fit=crop&w=300&h=300&q=80" alt="Patient receiving care" className="w-full h-full object-cover" />
            </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white/70 backdrop-blur-sm rounded-lg p-6 border border-rose-100">
              ...
              <Button size="lg" className="bg-gradient-to-r from-rose-500 to-pink-600 hover:from-rose-600 hover:to-pink-700 text-white px-8 py-4 text-lg w-full sm:w-auto">
