  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-gradient-to-br from-blue-600 to-indigo-700 text-white p-6 rounded-lg shadow-lg">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          <div className="flex items-center space-x-2">
            <Checkbox id="nid" className="border-gray-300 data-[state=checked]:bg-blue-500 data-[state=checked]:border-blue-500" />
          ...
          <div className="border border-dashed border-gray-300 rounded-lg p-4 text-center bg-gray-50 hover:bg-gray-100 transition-colors max-w-xs">
            <Upload className="h-5 w-5 text-gray-500 mx-auto mb-2" />
            <p className="text-sm text-gray-600 mb-3">Upload documents</p>
            <Button variant="outline" size="sm" className="text-sm h-8 px-4 border-gray-300 text-gray-700 hover:bg-white hover:text-gray-800">
              Choose Files
            </Button>
          </div>
          
          <div className="text-sm text-orange-700 bg-orange-50 p-3 rounded border-l-4 border-orange-400">
      ...
      <div className="space-y-3">
        <div className="flex items-start space-x-2">
          <Checkbox id="fundraiser-terms" className="mt-1 border-gray-300 data-[state=checked]:bg-blue-500 data-[state=checked]:border-blue-500" />
          <label htmlFor="fundraiser-terms" className="text-sm leading-relaxed">
            By proceeding, I agree to the <span className="text-blue-600 underline cursor-pointer hover:text-blue-700">Fundraiser Terms of Use</span>, the maximum charge or a bank account based on a monthly maximum of any.
          </label>
        </div>
        
        <div className="flex items-start space-x-2">
          <Checkbox id="privacy-policy" className="mt-1 border-gray-300 data-[state=checked]:bg-blue-500 data-[state=checked]:border-blue-500" />
          <label htmlFor="privacy-policy" className="text-sm leading-relaxed">
            I agree to the <span className="text-blue-600 underline cursor-pointer hover:text-blue-700">Terms of Use</span>, our <span className="text-blue-600 underline cursor-pointer hover:text-blue-700">Privacy Policy</span>, <span className="text-blue-600 underline cursor-pointer hover:text-blue-700">Fees & Pricing</span> and our guidelines about user Generated Content made available by you on our service as not to limit any activity and you grant us rights to process data about activity on our platform. I acknowledge and agree that I may receive text message from our service.
          </label>
        </div>
      </div>
    </div>
